...
class Calendario extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->calendario->setTimeRange('06:00:00', '20:00:00'); // visao diaria de tal hora a tal
        ...
        $this->calendario->addEvent( 1, 'Evento 1', date("Y-m-d h:i:s"), '2019-11-10 14:00:00', null, '#C04747', $obj1);
