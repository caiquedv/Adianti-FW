...
class ClienteForm extends TPage
{
    ...
    public function __construct()
    {
        ...
        parent::setTargetContainer('adianti_right_panel'); // coloca na cortina lateral
        ...
        $cidade_id  = new TDBUniqueSearch('cidade_id', 'curso', 'Cidade', 'id', 'nome'); // busca unica de registro
    ...
    public static function onSave($param)
    {
        try
        {
            ...
            TScript::create('Template.closeRightPanel()'); // fechar ao salvar
            
            $pos_action = new TAction( ['ClienteList', 'onReload'] ); // recarregar ao salvar
