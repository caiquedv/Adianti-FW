...
class FormularioSelecoesBanco extends TPage
{
    public function __construct()
    {
        ...
        $radio2   = new TDBRadioGroup('radio2', 'curso', 'Categoria', 'id', '{id} - {nome}'); // {id} - {nome} mascara 
        ...
        $search   = new TDBMultiSearch( 'search', 'curso', 'Categoria', 'id', 'nome'); // multi é bom p muitas opcoes se n use combo
