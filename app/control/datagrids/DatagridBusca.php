...
{ // essa busca é feita com os elemento que já estão em tela
    private $datagrid;
    
    public function __construct()
    {
        echo 'busca nao funciona, veja console';
        parent::__construct();
        ...
        $panel->addHeaderWidget( $input_busca ); // coloca o input no header do dg
